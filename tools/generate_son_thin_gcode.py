#!/usr/bin/env python3
"""Generate thin outline G-code for SON with O-horn."""
...
TEXT = "S\u01A0N"
OUT_GCODE = Path("test_gcode/son_o_horn_times_thin_80x60_onoff.gcode")
OUT_PREVIEW = Path("test_gcode/son_o_horn_times_thin_80x60_preview.png")
...
class Writer:
    ...
    def header(self, font_name: str, bounds: tuple[float, float, float, float]) -> None:
        ...
        self.lines.extend(
            [
                "; Thin Times-style SON on/off laser test",
                "; Text: SON with O-horn",
